...
class Index
{
    ...
    public function main(Data $config): string
    {
        ...
        $result = '';
        $body = File::read($config->get('directory.view') . File::basename(__CLASS__) . '/' . ucfirst(__FUNCTION__) . '.html');
        if($content_type === 'text/html'){
            $result = File::read($config->get('directory.view')  . 'Structure/Structure.html');
            $default = [
                '__LANGUAGE__' => 'en',
